<x-guest-layout>
    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="blood_group" class="block mt-1 w-full" type="text" name="blood_group" :value="old('blood_group')" required autocomplete="username" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="department_name" class="block mt-1 w-full" type="text" name="department_name" :value="old('department_name')" required autocomplete="username" />
