        ...
        <div class="mobile-menu d-md-none">
            <div class="mobile-menu-bar">
                <a style="width: 50px;" href="{{ route('dashboard') }}" class="d-flex me-auto">
                    <img style="width: 50px; margin:0 auto;" src="{{ asset('custom image/ete-logo.png') }}" alt="">
                </a>
        ...
        <div class="d-flex">
            ...
            <nav class="side-nav">
                <a href="{{ route('dashboard') }}" style="" class="intro-x d-flex align-items-center ps-5 pt-4">
                    <img style="width: 70px; margin:0 auto;" src="{{ asset('custom image/ete-logo.png') }}" alt="">
                </a>
                ...
                <div class="top-bar">
                    ...
                    <div class="intro-x dropdown w-8 h-8">
                        <div class="dropdown-toggle w-8 h-8 rounded-pill overflow-hidden shadow-lg image-fit zoom-in" role="button" aria-expanded="false" data-bs-toggle="dropdown">
                            <img alt="Rubick Tailwind HTML Admin Template" src="{{ Auth::user()->image }}">
                        </div>
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <x-dropdown-link :href="route('logout')" class="dropdown-item text-white bg-theme-1-hover dark-bg-dark-3-hover"
